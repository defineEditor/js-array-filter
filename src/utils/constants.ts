...
export const numberOperators = ["eq", "ne", "lt", "le", "gt", "ge", "in", "notin", "notMissing", "missing"];
...
} = Object.fromEntries(Object.entries(operatorLabels).map(([key, value]) => [value, key as FilterCondition["operator"]]));
